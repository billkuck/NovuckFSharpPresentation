...
Console.WriteLine("=== Iteration 2: Explicit Discount Tiers ===");
...
static decimal CalculateTotal(Customer customer, decimal spend)
{
    ...
    {
        Standard _ when spend >= 100.0m => spend * 0.1m,
        _ => 0.0m
    };
...
Console.WriteLine("✅ Domain language is explicit: Standard, Registered, Guest");
